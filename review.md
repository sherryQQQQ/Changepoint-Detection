...
The [experiment protocol](experiment-protocol.md) specifies a shared Python benchmark for BOCPD, PELT, CUSUM and HMM, a public-data VIX experiment, a futures extension, tuning grids, information sets, metrics and validation checks. These are proposals; no result or runnable benchmark is claimed.
